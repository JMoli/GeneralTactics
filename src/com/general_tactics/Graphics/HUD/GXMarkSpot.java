...
public class GXMarkSpot {
    ...
    public void draw(GL10 gl)
    {
        ...
        gl.glTranslatef(XMarkSpot.get_xMark_bankpos_x(), XMarkSpot.get_xMark_bankpos_y() - 0.4f , 0f);
...
public void drawXMark(GL10 gl)
{
    ...
    gl.glPushMatrix();
    gl.glScalef(0.25f,0.25f, 1f);
    gl.glTranslatef(GTEngine.get_mark_x_bankpos_x(), GTEngine.get_mark_x_bankpos_y() - 0.4f , 0f);
    gl.glMatrixMode(GL10.GL_TEXTURE);
    gl.glLoadIdentity();
    gl.glTranslatef(0.0f, 0.0f, 0.0f);
    draw(gl);
