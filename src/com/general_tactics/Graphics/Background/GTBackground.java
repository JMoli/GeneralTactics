package com.general_tactics.Graphics.Background;
...
public class GTBackground {
    ...
    public GTBackground()
    {
        ...
        id = ByteBuffer.allocateDirect(indicies.length * 4);
        id.put(indicies);
        id.position(0);

    }

    public void loadTexture(GL10 gl, int texture, Context context)//called on initialization
    {
